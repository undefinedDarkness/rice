...
;;;;; basic coloring
   ...
   `(default ((t (:foreground ,github-text :background "#fafafa"))))
...
;;;;; isearch
   ...
   `(mode-line
     ((,class (:foreground ,github-header-fg))
      ...
      (t :inverse-video t :underline (:color foreground-color :style line :position t))))
...
;;;;; org-mode
   ...
   `(org-level-2 ((t (:foreground ,github-text))))
   `(org-level-3 ((t (:foreground ,github-text))))
   `(org-level-4 ((t (:foreground ,github-text))))
   `(org-level-5 ((t (:foreground ,github-text))))
   `(org-level-6 ((t (:foreground ,github-text))))
   ...
   `(org-table ((t (:inherit fixed-pitch :foreground ,github-comment))))
   ...
   `(org-document-title ((t (:height 3.0 :foreground ,github-text))))
